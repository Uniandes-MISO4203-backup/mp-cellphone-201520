...
public class ProductService {
    ...
    /**
     * Servicio que actualiza las preguntas de los clientes Creado por
     * ggonzalez10
     *
     * @param dto
     * @return
    ...
    /**
     * Servicio para establecer preguntas sobre un producto.. Creado por
     * jh.rubiano10
     *
     * @param dto
     * @return
    ...
    public List<ProductDTO> getProducts() {
        if (provider != null) {
            if (page != null && maxRecords != null) {
                this.response.setIntHeader(X_TOTAL_COUNT, productLogic.countProductsByProvider(provider.getId()));
            }
            ...
            if (cellPhoneName != null) {
                ...
                if (page != null && maxRecords != null) {
                    this.response.setIntHeader(X_TOTAL_COUNT, productLogic.countProducts());
                }
    ...
    /**
     * Servicio para establecer filtros sobre los productos Creado por
     * ma.olivares10
     */
    @GET
    @Path("/cheapest/{id: \\d+}")
    ...
    public List<CommentDTO> getComments(CommentDTO user) {
        ...
        if (page != null && maxRecords != null) {
            this.response.setIntHeader(X_TOTAL_COUNT, commentLogic.countComment());
        }
    ...
    /**
     * Servicio para obtener la lista de modelos Creado por ma.olivares10
     */
    @GET
    @Path("/getModels")
    ...
    /**
     * Servicio para obtener la lista de modelos de un modelo especifico Creado
     * por ma.olivares10
     */
    @GET
    ...
    /**
     * Servicio para obtener la lista de marcas Creado por ma.olivares10
     */
    @GET
    @Path("/getBrands")
    ...
    /**
     * Servicio para obtener la lista de proveedores Creado por ma.olivares10
     */
    @GET
    @Path("/getProviders")
    ...
    /**
     * Servicio para obtener la lista de ciudades Creado por ma.olivares10
     */
    @GET
    @Path("/getCities")
    ...
    /**
     * Servicio para obtener la lista de de filtro por precios Creado por
     * ma.olivares10
     *
     * @param minPrice
     */
