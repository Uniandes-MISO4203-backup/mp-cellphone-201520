...
public class ShippingTypePersistenceTest {
    ...
    private void insertData() { 
        for (int i = 0; i < 3; i++) { 
            ...
            ShippingTypeEntity entity = ShippingTypeConverter.basicDTO2Entity(factory.manufacturePojo(ShippingTypeDTO.class)); 
            em.persist(entity); 
            data.add(entity); 
        } 
    }
    ...
    public void createShippingTypeTest() {
        PodamFactory factory = new PodamFactoryImpl();
        ShippingTypeEntity newEntity = ShippingTypeConverter.basicDTO2Entity(factory.manufacturePojo(ShippingTypeDTO.class));
